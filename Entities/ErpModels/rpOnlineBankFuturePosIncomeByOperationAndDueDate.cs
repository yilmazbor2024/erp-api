...
{
    [Table("rpOnlineBankFuturePosIncomeByOperationAndDueDate")]
    public partial class rpOnlineBankFuturePosIncomeByOperationAndDueDate
    {
        public rpOnlineBankFuturePosIncomeByOperationAndDueDate()
        {
        }

        [Key]
        [Required]
        public Guid OnlineBankFuturePosIncomeByOperationAndDueDateID { get; set; }
