...
namespace ErpMobile.Api.Entities.ErpModels
{
    ...
    public partial class trExpenseSlipLine
    {
        public trExpenseSlipLine()
        {
            ...
            tpExpenseSlipTaxLines = new HashSet<tpExpenseSlipTaxLine>();
        ...
        public virtual ICollection<tpExpenseSlipTaxLine> tpExpenseSlipTaxLines { get; set; }
