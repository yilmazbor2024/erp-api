...
{
    /// <summary>
    /// Yeni müşteri adresi oluşturma isteği modeli - prCurrAccPostalAddress tablosuyla %100 uyumlu
    /// </summary>
    public class CustomerAddressCreateRequestNew
    {
        ...
        /// Veritabanında NOT NULL, boş olamaz
        /// Örnek değer: "121.726"
        /// </summary>
        ...
        /// <summary>
        /// Posta Adresi ID (GUID) - prCurrAccPostalAddress.PostalAddressID alanı ile eşleşir
        /// Kullanım amacı: Adresin benzersiz GUID kimliği
        /// Veritabanında NULL olabilir
        /// </summary>
        ...
        /// <summary>
        /// Vergi dairesi - prCurrAccPostalAddress.TaxOffice alanı ile eşleşir
        /// Kullanım amacı: Müşterinin bağlı olduğu vergi dairesinin adını belirtir
        /// Veritabanında NULL olabilir
        /// </summary>
        ...
        /// <summary>
        /// Adres varsayılan mı? - prCurrAccDefault tablosu ile ilişkilidir
        ...
        /// <summary>
        /// Fatura adresi mi? - prCurrAccDefault tablosu ile ilişkilidir
        /// Kullanım amacı: Bu adresin müşterinin fatura adresi olup olmadığını belirtir
        /// Varsayılan değer: false
        /// </summary>
        public bool IsBillingAddress { get; set; }

        /// <summary>
        /// Sevkiyat adresi mi? - prCurrAccDefault tablosu ile ilişkilidir
        /// Kullanım amacı: Bu adresin müşterinin sevkiyat adresi olup olmadığını belirtir
        /// Varsayılan değer: false
        /// </summary>
