...
WHERE 1=1
    AND trInvoiceHeader.IsOrderBase = 0
    AND trInvoiceHeader.IsShipmentBase = 0
    AND trInvoiceHeader.ProcessCode = 'BP' -- Toptan Alış
    ...
    {StartDateFilter}
    {EndDateFilter}
ORDER BY trInvoiceHeader.InvoiceDate DESC, trInvoiceHeader.InvoiceHeaderID DESC
OFFSET {Offset} ROWS
