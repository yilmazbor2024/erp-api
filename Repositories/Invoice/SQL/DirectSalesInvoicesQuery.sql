...
WHERE 1=1
AND trInvoiceHeader.IsOrderBase = 0 --Sipariş bazlı değil
AND trInvoiceHeader.IsShipmentBase = 0 --İrsaliye bazlı değil
AND trInvoiceHeader.ProcessCode = 'DS' --Bayi Satış
{InvoiceNumberFilter}
{CustomerCodeFilter}
{VendorCodeFilter}
{CompanyCodeFilter}
