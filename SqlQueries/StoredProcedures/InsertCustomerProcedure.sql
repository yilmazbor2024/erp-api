CREATE PROCEDURE [dbo].[sp_GS_InsertCustomer]  (
...
BEGIN TRY
	...
	INSERT cdCurrAcc(CompanyCode, OfficeCode, CurrAccTypeCode, CurrAccCode, FirstName, LastName,CurrencyCode, CreatedDate, CreatedUserName, LastUpdatedDate, LastUpdatedUserName)
	SELECT @CompanyCode, @OfficeCode, @CurrAccTypeCode, @CurrAccCode, @FirstName, @LastName,@CurrencyCode ,@TXDate, @CreatedUserName, @TXDate, @CreatedUserName
	...
	BEGIN
		EXEC sp_GS_UpdateCustomerAddress 
